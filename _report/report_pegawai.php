        ...
        <td>
            <table width="100%" cellspacing="0" cellpadding="3" border="0">
                ...
                <tr>
                    ...
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['didik']).' </td>
                </tr>
                <tr>
                    <th align="left">Jurusan</th>
                    <th> : </th>
                    <td> '.strtoupper($pegawai[0]['jurusan']).' </td>
                </tr>
                <tr>
                    <th align="left">Instansi Induk</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['instansi']).' </td>
                </tr>
                <tr>
                    <th align="left">Status PNS</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['stat_pegawai']).' </td>
                </tr>
                <tr>
                    <th align="left">Pangkat CPNS</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['pangkatcpns']).' </td>
                </tr>
                <tr>
                    <th align="left">TMT CPNS</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['tmtcpns']).' </td>
                </tr>
                <tr>
                    <th align="left">Pangkat Terakhir</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['pangkatterakhir']).' </td>
                </tr>
				<tr>
                    <th align="left">TMT Pangkat Terakhir</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['tmtpangkatterakhir']).' </td>
                </tr>
                <tr>
                    <th align="left">TMT Pensiun</th>
                    <th> : </th>
                    <td> '.ucwords($pegawai[0]['tmtpensiun']).' </td>
                </tr>
            </table>
        </td>
    </tr>
